export default {
  ...
  bus: {
    eyebrow: '实时交通',
    title: '附近公交时刻',
    subtitle: '查找您最近的公交站并查看实时到站时间。',
    locating: '正在定位您的位置…',
    locateButton: '使用我的位置',
    retry: '重试',
    errors: {
      unsupported: '此设备不支持定位功能。',
      permissionDenied: '位置访问被拒绝。请在浏览器设置中启用定位后重试。',
      locationFailed: '无法确定您的位置，请重试。',
      noStopsFound: '您附近没有找到公交站。',
      busstopFetchFailed: '获取附近公交站失败。',
      arrivalsFetchFailed: '获取公交到站时间失败。',
    },
    nearbyStops: '附近公交站',
    nearestBadge: '最近',
    distanceAway: '距离 {distance}',
    noServices: '此站暂无实时公交数据。',
    arriving: '进站',
    wheelchairAccessible: '轮椅无障碍巴士',
    minutesShort: '{n} 分钟',
    updated: '更新于 {time}',
    refreshNow: '刷新',
    load: {
  ...
  ssKey: {
    title: 'Siri 捷径 API 密钥',
    subtitle: '生成一个 API 密钥，让 Siri 捷径自动化能够通过您的账户进行身份验证。',
    cardTitle: 'API 密钥管理',
    statusActive: '已启用',
    statusNotConfigured: '未配置',
    generate: '生成 API 密钥',
    ...
    copy: '复制',
    dismiss: '已保存 — 关闭',
    noKeyDesc: '生成一个 API 密钥，让 Siri 捷径自动化能够通过您的账户进行身份验证。',
    regenerateConfirmMessage: '重新生成将撤销您当前的 API 密钥，是否继续？',
    regenerateConfirmTitle: '重新生成密钥',
    revokeConfirmMessage: '此操作将永久撤销您的 API 密钥。使用该密钥的捷径将无法工作，直到您生成新密钥。',
    revokeConfirmTitle: '撤销密钥',
    cancel: '取消',
    usageTitle: '在 Siri 捷径中使用',
    usageStep1: '打开“捷径”应用，打开（或新建）您的捷径',
    usageStep2: '添加“获取 URL 内容”操作，将方法设为 POST，请求正文设为 JSON',
    usageStep3: '在“标头”中添加：X-API-Key → 粘贴您的密钥',
    usageStep4: '将 URL 设置为下方的接口地址',
    usageEndpointsTitle: '接口',
    usageBodyLabel: '请求体：',
  },
  travel: {
    ...
    planner: {
      ...
      noItems: '暂无行程项目。',
      noSchedule: '暂无安排 — 为已选项目指定日期后会显示在此处。',
    ...
    todo: {
      title: '待做事项',
      noItems: '暂无内容 — 从上方推荐中选择，或自行添加。',
      addItem: '+ 添加事项',
    },
    places: {
      title: '推荐景点',
      noItems: '暂无内容 — 从上方推荐中选择。',
      noneFound: '附近暂无推荐景点。',
      lookupFailed: '暂时无法加载景点，请稍后重试。',
    },
    note: {
      title: '注意事项',
      noItems: '暂无注意事项。',
      addItem: '+ 添加事项',
      addPromptLabel: '想记录什么内容？',
      mandatoryBadge: '必需',
      optionalBadge: '可选',
      deadlineWithinDays: '请在抵达前 {days} 天内提交',
      deadlineBeforeLanding: '可在落地前 {hours} 小时内的任何时间完成',
      openOfficialSite: '打开官方网站',
    },
    createTrip: {
      dialogTitle: '创建行程',
      destinationLabel: '目的地是？',
      destinationPlaceholder: '搜索城市或地点…',
      datesLabel: '出行时间？',
      exactDates: '具体日期',
      numberOfDays: '天数',
      cancel: '取消',
    ...
    recommendation: {
      exploreHint: '在地图上探索 — 点击标记即可添加到您的行程。',
      fillDestinationHint: '请填写目的地以获得更准确的推荐。',
      locating: '正在地图上定位推荐地点…',
      addToTrip: '+ 添加到行程',
      filterLabel: '标记',
      filterAll: '全部',
      filterSelectedOnly: '仅已选',
      close: '关闭',
      curatedBadge: '精选',
      noDetails: '暂无更多详情。',
    },
    mapStatus: {
      resolving: '正在解析地点位置…',
      noDestination: '请在上方填写目的地以查看推荐地点。',
      noLocationData: '暂无带位置信息的行程项目。',
      noFilterMatches: '没有符合当前筛选条件的项目。',
    },
    nav: {
      expand: '展开菜单',
      collapse: '收起菜单',
  ...
  toast: {
    ...
    adminSuggestionSaved: '已保存。',
    adminSuggestionFailed: '保存失败，请重试。',
    ...
    ssKeyCopied: 'API 密钥已复制。',
    ssKeyWarning: '请立即保存此密钥 — 不会再次显示。',
    ssKeyFailed: '生成 API 密钥失败。',
    ssKeyRevoked: 'API 密钥已撤销。',
    ...
    healthLoadFailed: '加载健康数据失败。',
  },
  health: {
    title: '健康',
    subtitle: '来自 Garmin Connect 的睡眠与压力数据。',
    highStressBanner: '今日检测到持续高压力：',
    stat: {
      sleepScore: '昨晚睡眠评分',
      restingHr: '静息心率',
      currentBodyBattery: '身体电量',
      currentStress: '当前压力',
    },
    chart: {
      todayTitle: '今日',
  ...
  budget: {
    ...
    list: {
      eyebrow: '预算追踪',
      title: '预算表',
      subtitle: '规划要买的东西，追踪实际花费。',
      newTable: '新建表格',
      newTableTitle: '新建预算表',
      tableName: '表格名称',
      tableNamePlaceholder: '例如：新居布置',
      mainCategory: '主分类',
      mainCategoryHint: '决定此表格中项目的建议分类。',
      create: '创建',
      cancel: '取消',
      myTables: '我的表格',
      sharedWithMe: '共享给我',
      ...
      deleted: '表格已删除',
      failed: '创建预算表失败',
      failedDelete: '删除预算表失败',
    },
    table: {
      share: '共享',
      shareTitle: '共享此预算表',
      invitePlaceholder: '协作者邮箱',
      invite: '邀请',
      inviteSuccess: '协作者已添加',
      inviteFailed: '添加协作者失败',
      remove: '移除',
      removeCollaboratorFailed: '移除协作者失败',
      noCollaborators: '暂无协作者。',
      renameFailed: '重命名表格失败',
      notFound: '未找到该预算表。',
      noItems: '暂无项目 — 请在下方添加。',
      uncategorized: '未分类',
      tab: {
      ...
      saveFailed: '保存更改失败',
      deleteFailed: '删除项目失败',
      itemDeletedToast: '“{name}” 已删除',
      undo: '撤销',
      restoreSuccess: '项目已恢复',
      restoreFailed: '恢复项目失败',
      statusChanged: '“{name}” 已移至{status}',
      sumBudget: '预算合计',
      sumActual: '实际合计',
    },
  },
  dashboard: {
    eyebrow: '仪表盘',
    title: '欢迎回来',
    subtitle: '这里是您的仪表盘 —— 目前还没有内容，但很快就会有。',
    recentTransactions: {
      title: '最近交易',
      empty: '暂无交易记录。',
      viewAll: '查看全部 →',
  ...
  admin: {
    suggestions: {
      ...
      addActivity: '+ 添加活动',
      destination: '目的地标签',
      destinationPlaceholder: '例：新加坡',
      titleCol: '标题',
      categoryCol: '分类',
      descriptionCol: '描述',
      actionsCol: '操作',
      estimatedHours: '预计时长（小时）',
      imagesLabel: '图片',
      addImage: '+ 添加图片链接',
      imagesHint: '粘贴图片链接 — 可先通过图床 (/imghost) 上传图片，再将链接粘贴到这里。',
      addTitle: '添加推荐内容',
      editTitle: '编辑推荐内容',
      save: '保存',
      deleteTitle: '删除推荐内容',
    ...
    logSearcher: {
      title: '日志查询',
      subtitle: '输入请求 ID，查看该请求在服务端的完整日志树。',
      placeholder: '粘贴请求 ID（例如 req_a1b2c）…',
      search: '搜索',
      notFound: '未找到该请求 ID 对应的日志记录。',
      invalidFormat: '这不是一个有效的请求 ID 格式。',
      resultCount: '找到 {n} 条匹配的日志记录',
      cardTile: '日志查询',
